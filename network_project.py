...
Original file is located at
    https://colab.research.google.com/drive/1GsZ0_n3VESm41GLcJ9CPIYlpvka8tv7X
"""
...
def visualize_network(N=100, p=0.1):
    G = gnp_random_graph(N,p)
    edge_dic={}
    for n in G.nodes:
      edge_dic[n] = [j for i,j in G.edges(n)]
...
def visualize_network(degree_seq,ensemble=100):
...
visualize_network(karate_degrees)
...
def generate_random_networks(n=100, p=0.1, degree_seq = karate_degrees, m=2):
    # ER 모델
